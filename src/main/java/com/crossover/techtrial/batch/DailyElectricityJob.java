...
public class DailyElectricityJob {
    ...
    public DailyElectricityJob(final HourlyElectricityService hourlyElectricityService,
            final DailyElectricityService dailyElectricityService, final PanelService panelService) {
    ...
    @SchedulerLock(name = "generateDailyElectricity")
    public void generateDailyElectricity() {
        process();
    }
    ...
    private void process() {
        ...
        for (Panel panel : panels) {
            ...
            LongSummaryStatistics summaryStatistics = hourlyElectricities.stream()
                    .mapToLong(HourlyElectricity::getGeneratedElectricity).summaryStatistics();

            DailyElectricity dailyElectricity = new DailyElectricity(panel, summaryStatistics.getSum(),
