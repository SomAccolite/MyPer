...
public class DailyElectricityJobTest {

    private DailyElectricityJob dailyElectricityAggregatorJob;
    ...
    public void setUp() {
        ...
        this.dailyElectricityAggregatorJob = new DailyElectricityJob(hourlyElectricityService, dailyElectricityService, panelService);
    }
    ...
    public void testConsolidateDailyElectricityGeneration() {
        ...
        this.dailyElectricityAggregatorJob.generateDailyElectricity();
    }
